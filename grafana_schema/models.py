...
@dataclass
class PickNameStringName:
    name: str | None = None


@dataclass
class PieChartFieldConfig:
...
ScopeFilterOperator = Literal[
    "equals", "not-equals", "not-one-of", "one-of", "regex-match", "regex-not-match"
]


@dataclass
class ScopeSpecFilter:
    key: str | None = None
    operator: ScopeFilterOperator | None = None
    value: str | None = None
...
@dataclass
class Custom1(PieChartFieldConfig, RecordStringUnknown):
    """
...
class ScopeSpec:
    ...
    filters: Sequence[ScopeSpecFilter] | None = None
    title: str | None = None
    type: str | None = None
...
@dataclass
class Custom(BarChartFieldConfig, RecordStringUnknown):
    """
    custom is specified by the FieldConfig field
    in panel plugin schemas.
    """
...
@dataclass
class FieldConfigBarChartFieldConfig:
...
@dataclass
class FieldConfigPieChartFieldConfig:
    color: FieldColor | None = None
    """
    Panel color configuration
    """
...
@dataclass
class Custom3(TimeSeriesFieldConfig, RecordStringUnknown):
    """
    custom is specified by the FieldConfig field
    in panel plugin schemas.
    """
...
@dataclass
class FieldConfigTimeSeriesFieldConfig:
    color: FieldColor | None = None
    """
    Panel color configuration
    """
...
@dataclass
class FieldConfigSourceBarChartFieldConfig:
    defaults: FieldConfigBarChartFieldConfig | None = None
...
@dataclass
class FieldConfigSourcePieChartFieldConfig:
    defaults: FieldConfigPieChartFieldConfig | None = None
...
@dataclass
class FieldConfigSourceTimeSeriesFieldConfig:
    defaults: FieldConfigTimeSeriesFieldConfig | None = None
...
@dataclass
class Scope(ScopeSpec, PickNameStringName):
    pass


@dataclass
class PrometheusDataQuery:
    adhocFilters: Sequence[ScopeSpecFilter] | None = None
    datasource: DataSourceRef | None = None
    """
    For mixed data sources the selected datasource is on the query level.
    For non mixed scenarios this is undefined.
    ...
    TODO this shouldn't be unknown but DataSourceRef | null
    """
    editorMode: Literal["builder", "code"] | None = None
    """
    Specifies which editor is being used to prepare the query. It can be "code" or "builder"
    """
    exemplar: bool | None = None
    """
    ...
    """
    format: Literal["heatmap", "table", "time_series"] | None = None
    """
    Query format to determine how to display data points in panel. It can be "time_series", "table", "heatmap"
    """
    groupByKeys: Sequence[str] | None = None
    hide: bool | None = None
    """
    If hide is set to true, Grafana will filter out the response(s) associated with this query before returning it to the panel.
    """
    ...
    """
    intervalFactor: float | None = None
    key: str | None = None
    """
    Unique, guid like, string (used only in explore mode)
    """
    legendFormat: str | None = None
    """
...
class Stat:
    ...
    """
    targets: Sequence[PrometheusDataQuery] | None = None
...
class TimeSeries:
    ...
    Panel description.
    """
    fieldConfig: FieldConfigSourceTimeSeriesFieldConfig | None = None
    gridPos: GridPos | None = None
    """
    Grid position.
    """
...
class BarChart:
    ...
    Panel description.
    """
    fieldConfig: FieldConfigSourceBarChartFieldConfig | None = None
    gridPos: GridPos | None = None
    """
    Grid position.
    """
...
@dataclass
class Custom2(TableFieldConfig, RecordStringUnknown):
    """
    custom is specified by the FieldConfig field
    in panel plugin schemas.
    """
...
@dataclass
class FieldConfigTableFieldConfig:
    color: FieldColor | None = None
    """
    Panel color configuration
    """
...
@dataclass
class FieldConfigSourceTableFieldConfig:
    defaults: FieldConfigTableFieldConfig | None = None
...
class PieChart:
    ...
    Panel description.
    """
    fieldConfig: FieldConfigSourcePieChartFieldConfig | None = None
    gridPos: GridPos | None = None
    """
    Grid position.
    """
...
class Table:
    ...
    Panel description.
    """
    fieldConfig: FieldConfigSourceTableFieldConfig | None = None
    gridPos: GridPos | None = None
    """
    Grid position.
    """
